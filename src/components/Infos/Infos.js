    ...
    return (
        <>
            ...
            <div className='container-choix'>
                ...
                {showFact ? <h2 style={{alignSelf: 'center', color: '#fff' ,margin: 0, height: '40px'}}>Nouvelle Facture</h2> : null}
                {showForm ? <h2 style={{alignSelf: 'center', color: '#fff',margin: 0, height: '40px'}}>Nouveau Devis</h2> : null}
